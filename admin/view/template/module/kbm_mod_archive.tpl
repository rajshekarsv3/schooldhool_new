	...
	<script id="ModuleTemplate" type="text/x-handlebars-template">
		<div id="Module_{{module.row}}" class="vtabs-content">
			...
			<table class="form">
				...
				<tr>
					<td><?php echo _t('entry_article_count'); ?></td>
					<td>
						<div class="kuler-switch-btn">
							<input type="hidden" name="modules[{{module.row}}][article_count]" value="0" />
							<input type="checkbox" name="modules[{{module.row}}][article_count]" value="1"{{#compare module.article_count 1}} checked="checked"{{/compare}} />
							<span class="kuler-switch-btn-holder"></span>
						</div>
					</td>
				</tr>
