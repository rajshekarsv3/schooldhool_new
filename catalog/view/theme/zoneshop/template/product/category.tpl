...
<?php echo $header; ?>
  <div class="container category-page">
    <div class="row">
      ...
      <?php } ?>
      <!-- Commenting This part of code to remove refine search
      <?php if ($categories) { ?>
      ...
      <div class="container product-filter">
        <div class="row">
          <div class="col-lg-2 col-sm-6 display">
            <?php echo $text_list; ?>
            <a onclick="display('grid');"><?php echo $text_grid; ?></a>
          </div>
          <div class="col-lg-4 col-sm-6 product-compare">
            <a href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a>
          </div>
          <div class="col-lg-3 col-sm-6 limit"><b><?php echo $text_limit; ?></b>
          ...
          <div class="col-lg-3 col-sm-6 sort"><b><?php echo $text_sort; ?></b>
            <select onchange="location = this.value;">
      ...
      <div class="product-list category-product-list">
        <?php foreach ($products as $product) { ?>
          ...
          <?php } elseif ($column_left || $column_right) { ?>
            <?php $class = 'col-lg-3 col-md-4 col-sm-6'; ?>
          <?php } else { ?>
